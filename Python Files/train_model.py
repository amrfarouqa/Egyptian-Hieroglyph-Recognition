...
print('Hieroglyph Vocabulary Size: %d' % ger_vocab_size)
print('Hieroglyph Max Length: %d' % (ger_length))
...
print(model.summary())
plot_model(model, to_file='../PNG Files/model.png', show_shapes=True)

# %%
# fit model
filename = '../Model Files/model.h5'
